...
FakeLidar::FakeLidar() : FakeSensorNode("fake_lidar")
...
sensor_msgs::msg::LaserScan FakeLidar::getDefaultLaserScan() {
...
int main(int argc, char * argv[])
{
    ...
    rclcpp::spin(std::shared_ptr<nav_testbench::FakeLidar>(new nav_testbench::FakeLidar()));
    rclcpp::shutdown();
    return 0;
}